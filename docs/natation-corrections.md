...
20. **Pyramide** : jamais un monolithe ~1750 m (surtout Ironman / triathlon perf) sans paliers ni consignes. Volume pyramide ≤ **1000 m** ; sommet ≤ ~300 m ; afficher la chaîne de paliers + repos ; le surplus du corps = séries lisibles (Nx100…), pas un « fill » appelé pyramide.
