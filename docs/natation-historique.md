...
| 2026-09-02 | Réf. support Telegram | Ligne copiée / Telegram : `séance n°6 \| réf. 01-42` (plus `UI n°` ni nom d’onglet). Niveau = bande Sheet (`débutant` / `intermédiaire` / `avancé`). `4nages: oui\|non`. Plus de `bande:` ni `nage: crawl`. | ✅ active |
