...
| 2026-08-28 | Cycle Sheet loin de J | Cycle **6 travail → test → allégée** (S-7 = test). Ordre vers J corrigé (plus d’allégée avant test). Garde début de plan : **4 sem. travail** avant test/allégée cycle ; S0/S-1 taper intacts. | ✅ active |
...
| 2026-08-28 | Catalogue Sheet vague 3 | Soft-branch **01–13** : Oly/Half/Full `07`–`08` + eau libre `09`–`13` (courte vs moy-long). Même règle await / pas de fallback composeur. Diplômes restent composeur (pas d’onglet Sheet). | ✅ active |
| 2026-08-28 | Catalogue Sheet vague 2 | Soft-branch étendu à **XS / Sprint 04–06** (`triathlon_xs` + `triathlon_sprint`). Même grille niveau / 4 nages que Nager. Oly/Half/Full, eau libre, diplômes = pas encore. | ↩ remplacée |
