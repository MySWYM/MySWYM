    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "0 24px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <Link to="/#pricing" style={{ color: C.grey, fontSize: 14, textDecoration: "none" }}>Tarifs</Link>
...
export default function Blog() {
  ...
  return (
    <div style={{ background: C.ink, minHeight: "100vh", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      {/* Hero */}
      <div style={{ paddingTop: 120, paddingBottom: 60, paddingLeft: 24, paddingRight: 24, textAlign: "center" }}>
